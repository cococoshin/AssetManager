...
public class BankController {
	...
	public String bankAdd(HttpSession session, @RequestParam String[] type, @RequestParam String[] bankname, @RequestParam String[] contents) {
//		parsing이 이방법 말고는 없나??
		...
		for (int i = 0; i < contents.length; i++) {
			...
			String b = bankname[i];
			String c = contents[i];
			BankDTO dto = new BankDTO(1, t, b, c, userid);
			list.add(dto);
		}	
		service.bankAdd(list);
		return "bank";//redirect시키기
	}//bankAdd end
